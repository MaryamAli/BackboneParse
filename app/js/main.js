...
var _cat_model = require('./cat_model');

var _cat_model2 = _interopRequireDefault(_cat_model);
...
exports['default'] = CatsCollection;
module.exports = exports['default'];

},{"./cat_model":1,"backbone":5}],4:[function(require,module,exports){
'use strict';
...
var _cats_collection2 = _interopRequireDefault(_cats_collection);

var _cat_template = require('./cat_template');

var _cat_template2 = _interopRequireDefault(_cat_template);

// Import CatModel from '.cat_model'

var APP_ID = 'agyBBicntlORhkPegv1ES8rpcNTEE2qclq8333Wl';
var API_KEY = 'WMfyy9mFvvS8j3AW7PLhuJMAf1yxKE7gw46nxe9I';
...
var cats = new _cats_collection2['default']();
...
function renderCats() {
  ...
  cats.each(function (cat) {
    ...
    var templateString = (0, _cat_template2['default'])(data);
